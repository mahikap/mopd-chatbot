...
class ChatBot extends Component {
  ...
  render() {
    ...
    const header = headerComponent || (
      <Header className="rsc-header" role='region' aria-labelledby='chatbot-title'>
        <HeaderTitle className="rsc-header-title visually-hidden" id='chatbot-title'>{headerTitle}</HeaderTitle>
        {floating && (
          ...
          <Footer className="rsc-footer" style={footerStyle}>
            {!currentStep.hideInput && (
              <Input
                ...
                aria-placeholder='Type the message'
                style={inputStyle}
                ref={this.setInputRef}
                className="rsc-input text"
                title='Message to send'
                aria-labelledby='message to send chatbot'
                id='chat-input'
                autoComplete='off'
